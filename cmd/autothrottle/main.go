...
func init() {
	...
	flag.IntVar(&Config.MetricsWindow, "metrics-window", 60, "Time span of metrics required (seconds)")
	...
	flag.IntVar(&Config.Interval, "interval", 60, "Autothrottle check interval (seconds)")
