...
func (s *Server) ValidateRequest(ctx context.Context, req any, kind int) (context.Context, context.CancelFunc, error) {
...
func (dl dummyLock) UnlockLogError(_ context.Context) { return }
func (dl dummyLock) Owner() any               { return nil }
